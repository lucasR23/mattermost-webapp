...
import {getCategoriesForCurrentTeam, getChannelsInCategoryOrder, getDisplayedChannels} from 'src/selectors/views/channel_sidebar';
import {DraggingState, GlobalState} from 'src/types/store';
