...
import {addChannelsInSidebar} from 'src/actions/views/channel_sidebar';
...
import {getCategoriesForCurrentTeam, getDisplayedChannels} from 'src/selectors/views/channel_sidebar';
