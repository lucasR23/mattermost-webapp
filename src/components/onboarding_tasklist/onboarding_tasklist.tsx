...
import {useFirstAdminUser, useIsCurrentUserSystemAdmin} from 'src/components/global_header/hooks';

import {getPrevTrialLicense} from 'mattermost-redux/actions/admin';
import {getShowTaskListBool} from 'src/selectors/onboarding';
...
import checklistImg from 'src/images/onboarding-checklist.svg';
import {
    useTasksListWithStatus,
    OnboardingTaskCategory,
    OnboardingTaskList,
} from 'src/components/onboarding_tasks';
import {useHandleOnBoardingTaskTrigger} from 'src/components/onboarding_tasks/onboarding_tasks_manager';
import {openModal} from 'src/actions/views/modals';
import {GlobalState} from 'src/types/store';
import OnBoardingVideoModal from 'src/components/onboarding_tasks/onboarding_video_modal/onboarding_video_modal';

import {Preferences, RecommendedNextStepsLegacy} from 'src/utils/constants';
