...
import EmojiPicker from 'src/components/emoji_picker';
import EmojiPickerHeader from 'src/components/emoji_picker/components/emoji_picker_header';

const GifPicker = makeAsyncComponent('GifPicker', React.lazy(() => import('src/components/gif_picker/gif_picker')));
