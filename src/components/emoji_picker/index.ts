...
import {incrementEmojiPickerPage, setUserSkinTone} from 'src/actions/emoji_actions';
import {getEmojiMap, getRecentEmojisNames, getUserSkinTone} from 'src/selectors/emojis';
