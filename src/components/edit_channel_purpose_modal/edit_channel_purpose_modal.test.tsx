...
import EditChannelPurposeModal, {EditChannelPurposeModal as EditChannelPurposeModalClass} from 'src/components/edit_channel_purpose_modal/edit_channel_purpose_modal';
