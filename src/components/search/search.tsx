...
import {isServerVersionGreaterThanOrEqualTo} from 'src/utils/server_version';
import {isDesktopApp, getDesktopVersion, isMacApp} from 'src/utils/user_agent';
import Constants, {searchHintOptions, RHSStates, searchFilesHintOptions} from 'src/utils/constants';
...
import UserGuideDropdown from 'src/components/search/user_guide_dropdown';
import SearchBar from 'src/components/search_bar/search_bar';
import SearchResults from 'src/components/search_results';
import Provider from 'src/components/suggestion/provider';
import SearchDateProvider from 'src/components/suggestion/search_date_provider';
import SearchChannelProvider from 'src/components/suggestion/search_channel_provider';
import SearchUserProvider from 'src/components/suggestion/search_user_provider';
import type {SearchType} from 'src/types/store/rhs';
