...
import type {updateNewMessagesAtInChannel} from 'src/actions/global_actions';
import type {CanLoadMorePosts} from 'src/actions/views/channel';
...
import {getPreviousPostId, getLatestPostId, getNewMessageIndex} from 'src/utils/post_utils';
