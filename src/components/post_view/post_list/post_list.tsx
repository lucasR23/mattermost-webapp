...
import {getOldestPostId, getLatestPostId} from 'src/utils/post_utils';
...
import {updateNewMessagesAtInChannel} from 'src/actions/global_actions';
import type {LoadPostsParameters, LoadPostsReturnValue, CanLoadMorePosts} from 'src/actions/views/channel';
