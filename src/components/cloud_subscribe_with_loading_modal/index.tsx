...
import CreditCardSvg from 'src/components/common/svg_images_components/credit_card_svg';
import PaymentSuccessStandardSvg from 'src/components/common/svg_images_components/payment_success_standard_svg';
import PaymentFailedSvg from 'src/components/common/svg_images_components/payment_failed_svg';
import IconMessage from 'src/components/purchase_modal/icon_message';
import ProgressBar, {ProcessState} from 'src/components/icon_message_with_progress_bar';
import {
