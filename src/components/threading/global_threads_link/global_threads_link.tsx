...
import ChannelMentionBadge from 'src/components/sidebar/sidebar_channel/channel_mention_badge';
import CRTWelcomeTutorialTip
    from '../../crt_tour/crt_welcome_tutorial_tip/crt_welcome_tutorial_tip';
import {GlobalState} from 'src/types/store';
import {isAnyModalOpen} from 'src/selectors/views/modals';
import Constants, {
    CrtTutorialSteps,
...
import CollapsedReplyThreadsModal
    from 'src/components/crt_tour/collapsed_reply_threads_modal/collapsed_reply_threads_modal';
