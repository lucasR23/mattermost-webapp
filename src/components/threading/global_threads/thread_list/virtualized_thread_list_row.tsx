...
import {NoResultsLayout} from 'src/components/no_results_indicator/types';
import {SearchShortcut} from 'src/components/search_shortcut/search_shortcut';
import {ShortcutKeyVariant} from 'src/components/shortcut_key';

import {Constants} from 'src/utils/constants';

import SearchHintSVG from 'src/components/common/svg_images_components/search_hint_svg';
