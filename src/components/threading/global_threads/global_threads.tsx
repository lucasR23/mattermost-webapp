...
import {GlobalState} from 'src/types/store/index';

import {useGlobalState} from 'src/stores/hooks';
import LocalStorageStore from 'src/stores/local_storage_store';
import {clearLastUnreadChannel} from 'src/actions/global_actions';
import {setSelectedThreadId} from 'src/actions/views/threads';
import {suppressRHS, unsuppressRHS} from 'src/actions/views/rhs';
...
import {Constants, PreviousViewedTypes} from 'src/utils/constants';
