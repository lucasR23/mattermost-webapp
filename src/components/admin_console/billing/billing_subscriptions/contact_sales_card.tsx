...
import {CloudLinks, CloudProducts} from 'src/utils/constants';
import PrivateCloudSvg from 'src/components/common/svg_images_components/private_cloud_svg';
import CloudTrialSvg from 'src/components/common/svg_images_components/cloud_trial_svg';
