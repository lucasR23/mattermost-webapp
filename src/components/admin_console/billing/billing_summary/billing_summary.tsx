...
import {BillingSchemes, CloudLinks, TrialPeriodDays} from 'src/utils/constants';
...
import EmptyBillingHistorySvg from 'src/components/common/svg_images_components/empty_billing_history_svg';
