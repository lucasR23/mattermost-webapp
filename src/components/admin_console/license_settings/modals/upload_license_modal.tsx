...
import WomanArmOnTable from 'src/components/common/svg_images_components/woman_arm_on_table_svg';
import HandsSvg from 'src/components/common/svg_images_components/hands_svg';
import FileSvg from 'src/components/common/svg_images_components/file_svg';
import LoadingWrapper from 'src/components/widgets/loading/loading_wrapper';

import {FileTypes, ModalIdentifiers} from 'src/utils/constants';
...
import {fileSizeToString, localizeMessage} from 'src/utils/utils';
