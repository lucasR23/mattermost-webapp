...
import AdminSidebar from 'src/components/admin_console/admin_sidebar/admin_sidebar';
...
import type {Props} from 'src/components/admin_console/admin_sidebar/admin_sidebar';
