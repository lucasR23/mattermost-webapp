...
import {getLastViewedChannelNameByTeamName, getLastViewedTypeByTeamName, getPreviousTeamId, getPreviousTeamLastViewedType} from 'src/selectors/local_storage';

import {GlobalState} from 'src/types/store';

import {PreviousViewedTypes} from 'src/utils/constants';
