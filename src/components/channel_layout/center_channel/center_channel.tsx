...
import PlaybookRunner from 'src/components/channel_layout/playbook_runner';
...
const LazyChannelHeaderMobile = makeAsyncComponent(
    ...
    React.lazy(() => import('src/components/channel_header_mobile')),
);

const LazyGlobalThreads = makeAsyncComponent(
    'LazyGlobalThreads',
    React.lazy(() => import('src/components/threading/global_threads')),
    (
...
const LazyActivityAndInsights = makeAsyncComponent(
    ...
    React.lazy(() => import('src/components/activity_and_insights/activity_and_insights')),
    (
        <div className='app__content'>
            <LoadingScreen/>
        </div>
