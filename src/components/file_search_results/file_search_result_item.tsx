...
import {fileSizeToString, copyToClipboard, localizeMessage} from 'src/utils/utils';
...
import FileThumbnail from 'src/components/file_attachment/file_thumbnail';
import Timestamp, {RelativeRanges} from 'src/components/timestamp';

import FilePreviewModal from 'src/components/file_preview_modal';
