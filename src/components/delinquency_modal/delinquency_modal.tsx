...
import {ModalIdentifiers, Preferences, TELEMETRY_CATEGORIES} from 'src/utils/constants';
import {GlobalState} from 'src/types/store';
import {openModal, closeModal as closeModalAction} from 'src/actions/views/modals';
