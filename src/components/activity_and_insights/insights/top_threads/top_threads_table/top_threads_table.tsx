...
import {selectPostAndParentChannel} from 'src/actions/views/rhs';
...
import {InsightsScopes, ModalIdentifiers} from 'src/utils/constants';
...
import Attachment from 'src/components/threading/global_threads/thread_item/attachments';
