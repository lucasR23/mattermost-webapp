...
import GenericUserProvider from 'src/components/suggestion/generic_user_provider';
import GenericChannelProvider from 'src/components/suggestion/generic_channel_provider.jsx';

import TextSetting, {InputTypes} from 'src/components/widgets/settings/text_setting';
