...
import {BoardsTourTip, PlaybooksTourTip} from 'src/components/onboarding_explore_tools_tour';
import {FINISHED, TutorialTourName} from 'src/components/onboarding_tour';

import {isSwitcherOpen} from 'src/selectors/views/product_menu';
