...
import MultiSelectCards from 'src/components/common/multi_select_cards';

import GithubSVG from 'src/components/common/svg_images_components/github_svg';
import GitlabSVG from 'src/components/common/svg_images_components/gitlab_svg';
import CelebrateSVG from 'src/components/common/svg_images_components/celebrate_svg';
import JiraSVG from 'src/components/common/svg_images_components/jira_svg';
import ZoomSVG from 'src/components/common/svg_images_components/zoom_svg';
import TodoSVG from 'src/components/common/svg_images_components/todo_svg';
