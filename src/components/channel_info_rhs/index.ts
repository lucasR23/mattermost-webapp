...
import {closeRightHandSide, showChannelFiles, showChannelMembers, showPinnedPosts} from 'src/actions/views/rhs';
...
import {muteChannel, unmuteChannel} from 'src/actions/channel_actions';
import {openModal} from 'src/actions/views/modals';
import {getDisplayNameByUser, getUserIdFromChannelId} from 'src/utils/utils';
