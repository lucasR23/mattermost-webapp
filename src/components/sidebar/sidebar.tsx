...
import NewChannelModal from 'src/components/new_channel_modal/new_channel_modal';
...
import CreateUserGroupsModal from 'src/components/create_user_groups_modal';
