...
import {clearChannelSelection, multiSelectChannelAdd, multiSelectChannelTo} from 'src/actions/views/channel_sidebar';
import {getFirstChannelName} from 'src/selectors/onboarding';
import {unsetEditingPost} from 'src/actions/post_actions';
import {isChannelSelected} from 'src/selectors/views/channel_sidebar';
...
import {FINISHED, OnboardingTourSteps, TutorialTourName} from 'src/components/onboarding_tour';
