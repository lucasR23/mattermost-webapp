...
import KeyboardShortcutSequence, {KEYBOARD_SHORTCUTS} from 'src/components/keyboard_shortcuts/keyboard_shortcuts_sequence';
import Tooltip from 'src/components/tooltip';
import OverlayTrigger from 'src/components/overlay_trigger';
import NotifyConfirmModal from 'src/components/notify_confirm_modal';
...
import {FileUpload as FileUploadClass} from 'src/components/file_upload/file_upload';
import ResetStatusModal from 'src/components/reset_status_modal';
import TextboxClass from 'src/components/textbox/textbox';
import PostPriorityPickerOverlay from 'src/components/post_priority/post_priority_picker_overlay';
import PriorityLabel from 'src/components/post_priority/post_priority_label';

import {Channel, ChannelMemberCountsByGroup} from '@mattermost/types/channels';
import {PostDraft} from 'src/types/store/draft';
...
import {FilePreviewInfo} from 'src/components/file_preview/file_preview';
import {ApplyMarkdownOptions, applyMarkdown} from 'src/utils/markdown/apply_markdown';
