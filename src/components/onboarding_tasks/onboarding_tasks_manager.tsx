...
import {trackEvent as trackEventAction} from 'src/actions/telemetry_actions';
import {setProductMenuSwitcherOpen} from 'src/actions/views/product_menu';
import {setStatusDropdown} from 'src/actions/views/status_dropdown';
...
import {
    ...
    TutorialTourName,
} from 'src/components/onboarding_tour';
...
import {
    ...
    switchToChannels,
} from 'src/actions/views/onboarding_tasks';

import {ModalIdentifiers, TELEMETRY_CATEGORIES, ExploreOtherToolsTourSteps} from 'src/utils/constants';
