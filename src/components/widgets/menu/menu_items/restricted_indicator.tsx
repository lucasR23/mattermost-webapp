...
import FeatureRestrictedModal from 'src/components/feature_restricted_modal/feature_restricted_modal';
...
import {Constants, LicenseSkus, ModalIdentifiers} from 'src/utils/constants';
