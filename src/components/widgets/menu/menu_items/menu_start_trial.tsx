...
import {isTrialLicense} from 'src/utils/license_utils';
...
const TrialBenefitsModal = makeAsyncComponent('TrialBenefitsModal', React.lazy(() => import('src/components/trial_benefits_modal/trial_benefits_modal')));
const LearnMoreTrialModal = makeAsyncComponent('LearnMoreTrialModal', React.lazy(() => import('src/components/learn_more_trial_modal/learn_more_trial_modal')));
