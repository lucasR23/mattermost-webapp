...
import {ModalData} from 'src/types/actions.js';

import {sortFileInfos} from 'mattermost-redux/utils/file_utils';

import * as GlobalActions from 'src/actions/global_actions';

import Constants, {AdvancedTextEditor, Locations, ModalIdentifiers, Preferences} from 'src/utils/constants';
...
} from 'src/utils/markdown/apply_markdown';
