...
import {ProductComponent, PluginComponent} from 'src/types/store/plugins';
...
import {loadRecentlyUsedCustomEmojis} from 'src/actions/emoji_actions';
import * as GlobalActions from 'src/actions/global_actions';
import {measurePageLoadTelemetry, trackEvent, trackSelectorMetrics} from 'src/actions/telemetry_actions.jsx';

import {makeAsyncComponent} from 'src/components/async_load';
import CompassThemeProvider from 'src/components/compass_theme_provider/compass_theme_provider';
import GlobalHeader from 'src/components/global_header/global_header';
import CloudEffects from 'src/components/cloud_effects';
...
import {HFRoute} from 'src/components/header_footer_route/header_footer_route';
import NeedsTeam from 'src/components/needs_team';
import OnBoardingTaskList from 'src/components/onboarding_tasklist';
import LaunchingWorkspace, {LAUNCHING_WORKSPACE_FULLSCREEN_Z_INDEX} from 'src/components/preparing_workspace/launching_workspace';
import {Animations} from 'src/components/preparing_workspace/steps';
import OpenPricingModalPost from 'src/components/custom_open_pricing_modal_post_renderer';
...
import Constants, {StoragePrefixes, WindowSizes} from 'src/utils/constants';
import {EmojiIndicesByAlias} from 'src/utils/emoji';
...
const LazyLogin = React.lazy(() => import('src/components/login/login'));
...
const LazySignup = React.lazy(() => import('src/components/signup/signup'));
const LazyTermsOfService = React.lazy(() => import('src/components/terms_of_service'));
const LazyShouldVerifyEmail = React.lazy(() => import('src/components/should_verify_email/should_verify_email'));
const LazyDoVerifyEmail = React.lazy(() => import('src/components/do_verify_email/do_verify_email'));
...
const LazyPreparingWorkspace = React.lazy(() => import('src/components/preparing_workspace'));
const LazyDelinquencyModalController = React.lazy(() => import('src/components/delinquency_modal'));
...
import TeamSidebar from 'src/components/team_sidebar';

import {UserProfile} from '@mattermost/types/users';

import {ActionResult} from 'mattermost-redux/types/actions';

import WelcomePostRenderer from 'src/components/welcome_post_renderer';
