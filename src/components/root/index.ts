...
import {getShowLaunchingWorkspace} from 'src/selectors/onboarding';
import {emitBrowserWindowResized} from 'src/actions/views/browser';
import {loadConfigAndMe, registerCustomPostRenderer} from 'src/actions/views/root';

import {initializeProducts} from 'src/plugins/products';
